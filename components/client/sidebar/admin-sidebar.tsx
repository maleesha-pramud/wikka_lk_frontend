...
import type { StaticData } from "@/lib/types/menu-items";
        ...
        <div className="flex h-full flex-col">
          ...
          <div className="flex items-center justify-between p-6 border-b border-border-light/50 dark:border-border-dark">
            {!isCollapsed && (
              <Link href="/" className="flex items-center gap-2">
                ...
                <div>
                  <span className="text-xl font-bold tracking-tight text-text-main-light dark:text-text-main-dark block">
                    Wikka.lk
                  </span>
          ...
          <nav className="flex-1 overflow-y-auto p-4">
            <div className="space-y-1">
              {staticValues.adminSidebarNavItems.map((item) => {
