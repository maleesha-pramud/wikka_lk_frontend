  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <section className="relative flex w-full flex-col items-center justify-center bg-white dark:bg-[#1f2937] py-20 px-4 overflow-hidden">
        ...
        <div className="absolute left-[-5%] top-[-10%] size-[500px] rounded-full bg-primary/5 blur-3xl"></div>
        <div className="absolute right-[-5%] bottom-[-10%] size-[400px] rounded-full bg-blue-500/5 blur-3xl"></div>
        <div className="container relative z-10 flex max-w-[800px] flex-col items-center gap-10 text-center">
          ...
          <div className="flex w-full flex-col rounded-2xl bg-white p-2 shadow-[0_8px_30px_rgb(0,0,0,0.08)] ring-1 ring-black/5 dark:bg-surface-dark dark:ring-white/10 md:flex-row md:items-center md:rounded-full">
            ...
            <button className="flex h-12 w-full items-center justify-center rounded-xl md:rounded-full bg-primary px-8 font-bold text-white transition-colors hover:bg-primary-hover shadow-lg shadow-primary/20 md:w-auto md:min-w-[140px]">
              Search
            </button>
          </div>
        </div>
      ...
      <section className="w-full border-b border-gray-100 bg-white py-6 dark:border-gray-800 dark:bg-[#1f2937]">
        <div className="mx-auto max-w-[1400px] px-6">
          <div className="no-scrollbar flex gap-6 overflow-x-auto py-2 md:grid md:grid-cols-8 md:place-items-center md:overflow-visible">
            <a className="group flex min-w-[90px] flex-col items-center gap-3 transition-transform hover:-translate-y-1" href="#">
      ...
      <main className="mx-auto flex w-full max-w-[1400px] flex-1 gap-10 px-6 py-12">
      ...
      <footer className="border-t border-gray-100 bg-white py-16 dark:border-gray-800 dark:bg-surface-dark">
        <div className="mx-auto flex max-w-[1400px] flex-col gap-12 px-6 md:flex-row md:justify-between">
        ...
        <div className="mx-auto mt-12 max-w-[1400px] border-t border-gray-100 pt-8 text-center text-xs text-gray-400 dark:border-gray-800 dark:text-gray-600 px-6">
